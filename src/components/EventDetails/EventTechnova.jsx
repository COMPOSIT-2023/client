            ...
            <section className="event-area bg-image ptb-120">
                <div className="col-lg-3 col-sm-6 p-0" style={{textAlign:"center"}}>
                    ...
                    <div className="btn-box" style={{marginBottom: "20px"}}>
                        ...
                        <a href = "https://docs.google.com/document/d/1tIn9Gi6wFebs5pkho4DA1B7UA74fQktTCLWmuFsUqj8/edit" target="_blank" className="btn btn-secondary">Rules & Regulations</a>
                    </div>
                </div>
                </div>
                                            ...
                                            <li className="accordion-item">
                                                <Link className="accordion-title" to="#">
                                                    ...
                                                    <div className="schedule-info">
                                                        ...
                                                        <ul>
                                                            <li> Participation can be individual or in a team of a maximum of three participants. </li>
                                            ...
                                            <li className="accordion-item">
                                                <Link className="accordion-title" to="#">
                                                    ...
                                                    <div className="schedule-info">
                                                        ...
                                                        <ul>
                                                            <li><b>Report submission round (Online):</b>
                                                            <ul><li>The paper and corresponding report should be submitted. Based on the difficulty and quality of the report, top submissions will be called for the final presentation round.</li></ul>
                                                            </li>
                                                            <li></li>
